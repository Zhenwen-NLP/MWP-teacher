...
def train_tree(input_batch, input_length, target_batch, target_length, nums_stack_batch, num_size_batch, generate_nums,
               ...
               merge_optimizer, output_lang, num_pos, batch_graph, teacher_encoder,teacher_classifier,epoch,if_teacher = True, english=False):
...
def teacher_pretrain(input_batch, input_length, target_batch, target_length, nums_stack_batch, num_size_batch, generate_nums,
               encoder, output_lang, num_pos, fake_batch,graph_batch, teacher_encoder, teacher_classifier, teacher_optimizer, if_multi = False, english=False):
    # sequence mask for attention
    max_len = max(input_length)
    ...
    batch_graph = torch.LongTensor(graph_batch)
    ...
    # Run words through encoder
    encoder_outputs_list, _ = encoder(input_var, input_length,batch_graph)
